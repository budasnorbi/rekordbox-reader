...
export const resolver = (file, id) => {
  ...
  for (let i = 0; i < len_entries; i++) {
    const { kind, k1, k2, k3, beat } = getPhrase(
      file,
      phrasesEntriesStart + i * len_entry_bytes
    );
    phrases.push({ kind, k1, k2, k3, beat, mood });
  }
  ...
  for (const index in phrases) {
    ...
    if (mood === 2) {
      ...
      if (kind === 2) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Verse 1";
        }
      }
      if (kind === 3) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Verse 2";
        }
      }
      if (kind === 4) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Verse 3";
        }
      }
      if (kind === 5) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Verse 4";
        }
      }
      if (kind === 6) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Verse 5";
        }
      }
      if (kind === 7) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Verse 6";
        }
      }
      if (kind === 8) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Bridge";
        }
      }
      if (kind === 9) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
          newLabel.name = "Chorus";
        }
      }
      if (kind === 10) {
        if (k1 === 0 && k2 === 0 && k3 === 0) {
  ...
  fs.writeFileSync(
    `./parses/phrases-${id}.json`,
    JSON.stringify(phrases, null, 2)
  );
  fs.writeFileSync(
    `./parses/labels-${id}.json`,
